...
TMB::compile("tmb_RE/tmb_MVN_with_mean.cpp")
dyn.load(dynlib("tmb_RE/tmb_MVN_with_mean"))
...
## Inference
obj <- MakeADFun(data = TMB_data, parameters = TMB_params, DLL="tmb_MVN_with_mean")
obj$hessian <- TRUE
