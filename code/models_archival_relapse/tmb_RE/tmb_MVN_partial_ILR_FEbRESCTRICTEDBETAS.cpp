...
// same as tmb_MVN_partial_ILR_FEb, but with all beta slopes = 0, to perform LRT comparing it to the full model
...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_VECTOR(beta); // coefficients for the fixed effects (only intercept!)
