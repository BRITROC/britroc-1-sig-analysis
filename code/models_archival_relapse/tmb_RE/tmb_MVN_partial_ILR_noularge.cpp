// doesn't make any sense; the covariance matrix cannot be estimated
...
//   // basic matrix for the likelihood of the ILR
...
//   for(int l=0;l<n;l++){ // likelihood for the random effects (multivariate normal)
//     nll += VECSCALE_t(nll_mvn, exp(logs_sd_RE))();
//   }
