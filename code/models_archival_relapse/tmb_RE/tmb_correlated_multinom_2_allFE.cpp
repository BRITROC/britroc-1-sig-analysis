...
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_MATRIX(u_large); // RE: covariances
  ...
  // if not inferring logs_sd_RE
  //  vector<Type> logs_sd_RE(d);
  //  logs_sd_RE.fill(1);
  // fill in covariance matrix with a diagonal matrix
//  matrix<Type> cov_RE(d,d);
//  cov_RE.fill(0);                   // Fill the whole matrix
//  cov_RE.diagonal() = 1;            // Create diagonal matrix
